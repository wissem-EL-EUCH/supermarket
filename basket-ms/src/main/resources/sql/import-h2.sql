...
VALUES ('Apple', 'Red Apple', 1, 0.20);
INSERT INTO PRODUCT (name, description, quantity, price)
VALUES ('Orange', 'Delicious Orange', 1, 0.50);
INSERT INTO PRODUCT (name, description, quantity, price)
VALUES ('Watermelon', 'Juicy Watermelon', 1, 0.80);
INSERT INTO PRODUCT (name, description, quantity, price)
VALUES ('Melon', 'Juicy melon', 1, 0.60);
INSERT INTO PRODUCT (name, description, quantity, price)
VALUES ('lemon', 'yellow lemon', 1, 0.30);